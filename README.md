...
Basically, MOSFET failure rate is so small ( typically \(10^{-6}\) ) that [Monte Carlo method](https://en.wikipedia.org/wiki/Monte_Carlo_method) would be costly ( \\(10^8\\) ~ \\(10^9\\)
