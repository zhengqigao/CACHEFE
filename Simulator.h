...
public:
	simulator();
	~simulator();
	int M_ND_[NumTrans] , M_NG_[NumTrans], M_NS_[NumTrans] ;
	int M_TYPE_[2 * NumTrans];
	double M_VT_[2 * NumTrans];
	double M_W_[2 * NumTrans] ;
	double M_L_[2 * NumTrans] ;
	double M_MU_[2 * NumTrans] ;
	double M_COX_[2 * NumTrans] ;
	double M_LAMBDA_[2 * NumTrans];
	double M_COV_[2 * NumTrans];
	/*
